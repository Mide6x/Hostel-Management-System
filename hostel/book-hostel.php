...
if (isset($_POST['submit'])) {
	...
	$pcity = $_POST['pcity'];
	$pstate = $_POST['pstate'];
	$query = "insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,pmntAddress,pmntCity,pmnatetState) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	$stmt = $mysqli->prepare($query);
	$rc = $stmt->bind_param('iiiisisissssisississssss', $roomno, $seater, $feespm, $foodstatus, $stayfrom, $duration, $course, $regno, $fname, $mname, $lname, $gender, $contactno, $emailid, $emcntno, $gurname, $gurrelation, $gurcntno, $caddress, $ccity, $cstate, $paddress, $pcity, $pstate);
	$stmt->execute();
											...
											?>
												<div class="form-group">
													<label class="col-sm-4 control-label">
														<h4 style="color: green" align="left"><b>Room Related Information</b></h4>
													</label>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Semester Date</label>
													<div class="col-sm-8">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select name="duration" id="duration" class="form-control">
															<option value="">Select Duration in Month (Maximum of 6 months which is a semester)</option>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">
														<h4 style="color: green" align="left"><b>Personal Information</b></h4>
													</label>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select name="course" id="course" class="form-control" required>
															...
															while ($row = $res->fetch_object()) {
															?>
																<option value="<?php echo $row->course_fn; ?>"><?php echo $row->course_fn; ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
												...
												?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" name="contact" id="contact" value="+234 <?php echo $row->contactNo; ?>" class="form-control" readonly>
														</div>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label">
														<h4 style="color: green" align="left"><b>Guardian Address </b></h4>
													</label>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label">
														<h4 style="color: green" align="left"><b>Permanent Address </b></h4>
													</label>
												</div>


												<div class="form-group">
													<label class="col-sm-5 control-label">Permanent Address is the same as Guardian address : </label>
													<div class="col-sm-4">
