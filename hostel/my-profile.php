...
<div class="col-sm-8">
<input type="text" name="course" id="course"  class="form-control" maxlength="10" value="<?php echo $row->course;?>" required="required">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="hostel" id="hostel"  class="form-control" maxlength="20" value="<?php echo $row->hostel;?>" required="required">
</div>
</div>
